<%@ Page Title="" Language="C#" MasterPageFile="~/adminaccounting.Master" AutoEventWireup="true" CodeBehind="adminaccountingsubcategoryprocess.aspx.cs" Inherits="mnwebproject.adminaccountingsubcategoryprocess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <table>
        <tr>
            ...
            <td class="style101">
                <asp:Label ID="Label31" runat="server" Text="Muhasebe Alt Kategori İşlemleri" Style="color: White; font-size: large;"></asp:Label>
            </td>
            <td class="style2">
        ...
        <asp:View ID="View1" runat="server">
            <table>
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="Label9" runat="server" Text="Kategori" CssClass="label"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="Label10" runat="server" Text=":" CssClass="label"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="DropAddCatTitle" runat="server" CssClass="inputs" Width="202px" OnSelectedIndexChanged="DropAddCatTitle_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Label ID="Label3" runat="server" Text="Alt Kategori Başlığı" CssClass="label"></asp:Label>
                    </td>
                    <td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Kategori ">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCattitle" Width="350px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_CAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Alt Kategori Başlığı">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCategory" Width="460px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_SUBCAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="lblcategoryname" runat="server" Text="" Visible="false"></asp:Label><asp:TextBox ID="txtcategoryadi" runat="server" CssClass="inputs"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <td>
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Kategori">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDeleteCategorytitle" Width="350px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_CAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Alt Kategori Başlığı">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDeleteCategoryName" Width="460px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_SUBCAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:CommandField ButtonType="Button" SelectText="Aç"
        ...
        <asp:View ID="View4" runat="server">
            <table>
                <tr>
                    <td></td>
                    <td>
                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" Width="900px" BorderColor="#CCCCCC"
                            BorderStyle="None" BorderWidth="1px" CellPadding="4" BackColor="White">
                            <Columns>
                                <asp:TemplateField HeaderText="ID" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Kategori">
                                    <ItemTemplate>
                                        <asp:Label ID="lblListCategorytitle" Width="380px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_CAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Alt Kategori Başlığı">
                                    <ItemTemplate>
                                        <asp:Label ID="lblListCategory" Width="500px" CssClass="label" Text='<%# DataBinder.Eval(Container,"DataItem.ACCO_SUBCAT_TITLE") %>'
                                            runat="server" Visible="true"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
