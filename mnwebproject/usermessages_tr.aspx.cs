...
{
    public partial class usermessages_tr : System.Web.UI.Page
    {
        ...
        protected void BtnWriteMsg_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (Control2(lblid.Text) && Control3(lbluserid.Text))
                {
                    ...
                    lblwritemsg.Text = "Mesaj Gönderildi";
                    connect.Close();
        ...
        protected void BtnSend_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Control2(lblid.Text) && Control3(lbluserid2.Text))
                {
                    ...
                    lblanswermsg.Text = "Mesaj Gönderildi"; 
                    connect.Close();
                }
                else {
                    connect.Open();
        ...
        protected void TextSelectUser_Textchanged(object sender, EventArgs e)
        {
            ...
            if (Control(TextSelectUser.Text))
            {
                ...
                durum.Text = "Bu Kullanıcıya Mesaj Gönderebilirsiniz...";
            }
            ...
            else
            {
                ...
                durum.Text = "Kullanıcı Bulunamadı... ";
            }
        }   
    }
}