<%@ Page Title="" Language="C#" MasterPageFile="~/main_en.Master" AutoEventWireup="true" CodeBehind="userlogin_en.aspx.cs" Inherits="mnwebproject.userlogin_en" %>
...
<td class="style13"></td>
<td class="style17">
    <asp:Label ID="Label1" runat="server" Text="Username" CssClass="label"></asp:Label></td>
<td>
...
<td></td>
<td>
    <asp:Button ID="BtnLogin" runat="server" Text="Sing In" CssClass="icerikbutton" OnClick="BtnLogin_Click" />
...
<td class="style17"></td>
<td></td>
<td><asp:Button ID="Btnforgotpassword" runat="server" Text="Forgot Password?" 
