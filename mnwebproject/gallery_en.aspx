<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gallery_en.aspx.cs" Inherits="mnwebproject.gallery_en" %>
...
<body style="background-color:#E7E4E4;">
    <form id="form1" runat="server">
        <div>
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="Verdana" Font-Size="Large" PostBackUrl="~/photogallery_en.aspx">Back to Photo Gallery Page</asp:LinkButton>
