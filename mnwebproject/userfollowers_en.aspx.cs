...
{
    public partial class userfollowers_en : System.Web.UI.Page
    {
        ...
        void doldur()
        {
            ...
            string SQL = "SELECT * FROM T_FOLLOW TF,T_USER TU,T_USER_PROFILE_PHOTO TUPP where TU.ID=TF.FOLLOWING_USER_ID and TU.ID=TUPP.PROFILE_PHOTO_USER_ID and TF.FOLLOWED_USER_ID='" + lblid.Text + "' and TF.FOLLOW_CONFIRM=1 order by TF.ID desc";
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("userprofile_en.aspx?id=" + e.CommandArgument);
            }
        }
