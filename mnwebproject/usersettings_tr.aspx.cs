...
{
    public partial class usersettings_tr : System.Web.UI.Page
    {
        ...
        protected void Addcountry()
        {
            ...
            DropCountry.Items.Add(new ListItem("Seçiniz!", "0"));
        ...
        protected void Addcity()
        {
            ...
            DropCity.Items.Add(new ListItem("Seçiniz!", "0"));
        ...
        protected void BtnUpdateProfilePhoto_Click(object sender, EventArgs e)
        {
            ...
            lblmsgprofildegistirme.Text = "Profil Fotoğrafı Değiştirildi";
            connect.Close();
        ...
        protected void BtnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            ds.Dispose();
            lblmsg.Visible = true;
            lblmsg.Text = "Şifreniz Değiştirildi";
