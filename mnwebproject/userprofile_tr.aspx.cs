...
{
    public partial class userprofile_tr : System.Web.UI.Page
    {
        ...
        protected void kontroltakip()
        {
            ...
            else
            {
                ...
                BtnFollow.Text = "Takip Etmeyi Bırak";
            }
        }
        ...
        protected void BtnFollow_Click(object sender, EventArgs e)
        {
            ...
            if (!Control(lblid.Text))
            {
                ...
                lbldurum.Text = "Takip İsteği Gönderildi";
                BtnFollow.ForeColor = Color.Red;
                BtnFollow.Text = "Takip Etmeyi Bırak";
                connect.Close();
            }
            else
            {
                ...
                lbldurum.Text = "Kullanıcıyı Takibi Bıraktınız";
                BtnFollow.ForeColor = Color.Green;
                BtnFollow.Text = "Takip Et";
                connect.Close();
        ...
        protected void BtnConfirm_Click(object sender, EventArgs e)
        {
            ...
            lbldurum.ForeColor = Color.Green;
            lbldurum.Text = "Kullanıcı Artık Seni Takip Edebiliyor";
        ...
        protected void BtnNotConfirm_Click(object sender, EventArgs e)
        {
            ...
            lbldurum.Visible = true;
            lbldurum.ForeColor = Color.Red;
            lbldurum.Text = "Kullanıcının Takip Etme İsteğini Kaldırdınız";
            komut.Fill(dt);
            connect.Close();
        ...
        protected void BtnSendMessage_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (Control2(lblgonderenid.Text) && Control3(lblid.Text))
                {
                    ...
                    lblmessage.Text = "Mesaj Gönderildi";
                    connect.Close();
                }
                else
                {
