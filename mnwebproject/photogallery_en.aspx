<%@ Page Title="" Language="C#" MasterPageFile="~/main_en.Master" AutoEventWireup="true" CodeBehind="photogallery_en.aspx.cs" Inherits="mnwebproject.photogallery_en" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content" style="text-align: justify">
        ...
        <asp:Image ID="Image1" runat="server" Height="138px" ImageUrl='<%# Eval("CAT_PHOTO_URL", "photocatgallery/{0}") %>'   Width="168px" /></td>
                ...
                <tr>
                <td style="height: 25px; background-color: #E2E2E2; text-align: center; width:168px;">
               <asp:Button ID="BtnKisiProfili" runat="server" CommandName="Details" CommandArgument='<%#Eval("ID")%>' Text="Go to Gallery" CssClass="buttons" Font-Size="14px" />
                </td>
                </tr>
            </table>    
            </ItemTemplate>
