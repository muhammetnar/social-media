...
{
    public partial class userregistration_tr : System.Web.UI.Page
    {
        ...
        protected void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                lblmsg.Text = "Kullanıcı Adı Boş Geçilemez";
            }
            else
            {
                lblmsg.Text = "Bu Kullanıcı Adını Başkası Kullanıyor";
            }
            connect.Close();
        ...
        protected void username_Textchanged(object sender, EventArgs e)
        {
            ...
            if (Control(username.Text))
            {
                ...
                durum.Text = "Bu Kullanıcı Adını Başkası Kullanıyor";
            }
            else if ((username.Text) == null)
            {
                durum.ForeColor = Color.Red;
                durum.Text = "Kullanıcı Adı Boş Geçilemez..";
            }
            else
            {
                durum.ForeColor = Color.Green;
                durum.Text = "Bu Kullanıcı Adı Kullanılabilir ";
            }
        }
    }
}