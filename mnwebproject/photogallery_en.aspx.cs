...
{
    public partial class photogallery_en : System.Web.UI.Page
    {
        ...
        void doldur()
        {
            ...
            string SQL = "select * from T_PHOTOGALLERY_CATEGORY where CAT_PHOTO_LANGUAGE='EN' order by ID desc ";
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("gallery_en.aspx?id=" + e.CommandArgument);
            }
        }
    }
}