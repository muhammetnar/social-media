<%@ Page Title="" Language="C#" MasterPageFile="~/main_en.Master" AutoEventWireup="true" CodeBehind="about_en.aspx.cs" Inherits="mnwebproject.about_en" %>
      ...
      <table>
        ...
        <ItemTemplate>
           ...
           <asp:Label ID="HAKKIMDA_BASLIK" runat="server" 
                Text='<%# Bind("ABOUT_TITLE_EN") %>' ForeColor="Red" CssClass="label" Font-Size="Medium" />
          <br />
             <br />
            <asp:Label ID="HAKKIMIZDA_ICERIK" runat="server" 
                Text='<%# Bind("ABOUT_CONTENT_EN") %>' CssClass="label" Font-Size="Small" />
            <br />
